    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                prefaced with a short title or heading that attempts to 
                summarize the topic of the section it precedes. 
                ...
                There are 6 heading tags for different sizes: h1, h2, h3, h4, h5, and h6. Tag h1 is the largest heading 
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1">
                This is a paragraph. 
                We often separate a long set of sentences 
                with vertical spaces to make the text 
                easier to read. Browsers ignore vertical 
                white spaces and render all the text as 
                ...
                The paragraph tag is used to format 
                vertical gaps between long pieces of 
                text like this one.</p>

                <p id="wd-p-3">
                This is the second paragraph. 
                Even though there is a deliberate white 
                gap between the paragraph above and 
                this paragraph, by default browsers 
                render them as one contiguous piece of 
                text as shown here on the right.</p>

                <p id="wd-p-4">
                This is the third paragraph. 
                Wrap each paragraph with the paragraph
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    id="wd-text-fields-email"></input><br/>

                    <label htmlFor="wd-text-fields-salary-start">Salarting Salary: </label>
                    <input type="number"
                    placeholder="100000"
                    id="wd-text-fields-salary-start"></input><br/>
                    ...
                    id="wd-text-fields-dob"></input><br/>
